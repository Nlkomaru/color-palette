...
interface ColorPickerProps extends ColorPickerPrimitiveProps, Pick<PopoverContentProps, "placement"> {
  label?: string;
  className?: string;
      ...
      <ColorPickerPrimitive {...props}>
        <Popover>
          <Button
            ...
            intent="plain"
            className={twJoin("*:data-[slot=color-swatch]:-mx-0.5 w-auto px-2.5", !label && "size-10")}
          >
