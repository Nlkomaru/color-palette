...
const buttonStyles = tv({
  base: [
    ...
    "inset-ring inset-ring-fg/20 bg-(--btn-bg) pressed:bg-(--btn-overlay) text-(--btn-fg) hover:bg-(--btn-overlay) dark:inset-ring-fg/15 dark:shadow-none",
  ...
  variants: {
    intent: {
      ...
      outline: ["shadow-none outline-primary [--btn-fg:var(--color-fg)] [--btn-overlay:theme(--color-secondary/90%)]"],
      plain: [
